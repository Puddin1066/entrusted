/**
 * FAQ copy + SEO: targets high-intent district searches (bilingual evaluation, ML/EL,
 * IEP/triennial, FBA-BIP, MA/RI coverage). Used on the homepage and FAQPage JSON-LD.
 */
export const homepageFaq = {
  sectionTitle: "Questions districts ask",
  sectionSubtitle:
  ...
  items: [
    ...
    {
      question: "What is the typical process after a district reaches out?",
      answer:
