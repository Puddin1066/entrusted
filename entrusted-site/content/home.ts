export const homeContent = {
  ...
  process: {
    title: "Process",
    intro: "Working together is straightforward and designed to fit district workflows.",
    steps: [
      {
        title: "Inquiry",
        description: "Initial outreach regarding evaluation or consultation needs",
      },
      {
        title: "Consultation",
        description: "Clarify case type, timeline, and service needs",
      },
      {
        title: "Records Review",
        description: "Review relevant educational and psychological records",
      },
      {
        title: "Assessment",
        description: "Testing, interviews, and observation as appropriate",
      },
      {
        title: "Reporting & Meeting Support",
        description: "Written report and team participation if requested",
      },
    ],
  },
  resourcesPreview: {
    title: "Resources for District Teams",
    copy:
    ...
    cta: "View Director Resources",
  },
  ctaBand: {
    headline: "Need bilingual psychological evaluation support?",
    copy: "If your team needs culturally responsive assessment, multilingual learner expertise, or short-term evaluation coverage, Entrusted can help.",
